...
| **Datum** | 2026-07-03 |
| **Veže se uz** | `DR-WFL-001` (odluka), `NFRQ-ORG-04` (`03-NFRQ/`), memorija `routing-capability-dr` |
...
### WP5 — NFRQ-ORG-01 promocija (per-class fan-in)
...
### WP6 — Automatizacija NFRQ-ORG-04 lint kriterija
