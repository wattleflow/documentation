...
`blackwattle` (`src/wattleflow/oscal/`, `src/wattleflow/decorators/oscal/`). Registar
...
| [14.13](../02-FRQ/FRQ-OSCAL-14.13-component-bases.md) | `OSCALConnection`, `OSCALDriver`, `OSCALProcessor` — vrata na bazi | `blackwattle` |
...
| ~~traži DR~~ **otpalo** | pitanje ovisnosti nestalo je vendiranjem OSCAL sloja u `blackwattle`; nijedna distribucija ne ovisi o `wattleflow-oscal` | [HLRQ-14](../01-HLRQ/HLRQ-14-oscal.md) §7 t.1 |
