# NFR-OBS-01 — Audit levels: meaning, audience and placement

| | |
|---|---|
| **Status** | Accepted (`DR-WFL-018`, 2026-08-23; amended by `DR-WFL-021`, 2026-08-24) |
...
* **`INFO`** carries **two** kinds of record (`DR-WFL-021`): the **work-unit boundary**, written
  ...
  [`NFR-OBS-03`](NFR-OBS-03-audit-ownership-volume-EN.md).
...
|---|---|
| Signal detection theory; base rate (same anchor as [`NFR-SEC-04`](NFR-SEC-04-detection-operating-point-EN.md)) | false alarms wreck the operating point: an `ERROR` that is not a failure spends the attention a real failure needs |
...
Record fields — [`NFR-OBS-02`](NFR-OBS-02-audit-fields-EN.md).
Volume and ownership — [`NFR-OBS-03`](NFR-OBS-03-audit-ownership-volume-EN.md).
Content confidentiality — [`NFR-SEC-06`](NFR-SEC-06-audit-confidentiality-EN.md).
