# NFR-SEC-01 — Blast-radius containment
...
the edge** (the MDL mirror; see [`NFR-SEC-02`](NFR-SEC-02-attack-surface-EN.md)).
...
3. No clean-core hub has **third-party code in its transitive `Blast`** — see
   [`NFR-SEC-03`](NFR-SEC-03-supply-chain-locality-EN.md).
