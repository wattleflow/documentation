# NFRQ-SEC-06 — Audit-record confidentiality

| | |
|---|---|
| **Status** | **Accepted** (2026-08-13) |
| **Quality (25010)** | Security — confidentiality |
| **Decision** | [`DR-WFL-008`](../04-DR/DR-WFL-008-audit-record-content.md) |
...
> [`NFRQ-OBS-01/02/03`](NFRQ-OBS-01-audit-levels-EN.md) govern the record's **readability and
...
1. **No splat.** `**kwargs` is **not forwarded** into a logging call: a component's **input
   surface** (`NFRQ-ORG-07`, `ALLOWED`) and its **recording surface** are different sets. The
   criterion is shared with [`NFRQ-OBS-02`](NFRQ-OBS-02-audit-fields-EN.md) c.5.
...
4. The operating point is subject to
   [`NFRQ-SEC-04`](NFRQ-SEC-04-detection-operating-point-EN.md): **redaction that disables
...
## 5. Why `NFRQ-ORG-07` is missing

Criterion 1 cites `NFRQ-ORG-07` (input surface / `ALLOWED`) — a requirement **measured by the lint
