# NFR-ORG-04 — Cross-cutting capability as a helper

| | |
|---|---|
| **Status** | Proposal (Draft) |
| **Quality (25010)** | Maintainability — modularity, reusability, analysability |
| **Decision** | [`DR-WFL-001`](../workflow/dr/DR-WFL-001-helper-capabilities.md) |
...
([`NFR-ORG-01`](NFR-ORG-01-helper-locality-EN.md) c.4); class names follow
