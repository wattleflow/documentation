# NFR-DEF-01 — Common definitions

| | |
|---|---|
| **Role** | Terms used by every `NFR-ORG-*` requirement; the definition lives here, everything else references it |
...
[`NFR-SEC-03`](NFR-SEC-03-supply-chain-locality-EN.md) and `CLAUDE.md` §7.4.

## 4. Traceability

`METHODOLOGY.md` §6 (traceability is a graph, not a chain) · `DOCTRINE.md` D-12 (five controlled
vocabularies) · `NFR-ORG-01`, `NFR-ORG-02`, `NFR-ORG-04`.
