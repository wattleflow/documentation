# NFR-ORG-01 — Dependency locality of helper classes

| | |
|---|---|
| **Status** | In force |
| **Quality (25010)** | Maintainability — modularity, reusability, analysability |
| **Decisions** | [`DR-WFL-001`](../workflow/dr/DR-WFL-001-helper-capabilities.md) · [`DR-WFL-019`](../workflow/dr/DR-WFL-019-helper-fan-in-is-diagnostic.md) · [`DR-WFL-017`](../workflow/dr/DR-WFL-017-enums-belongs-to-the-core.md) |
| **Enforcement** | `wem_lint` — `domain_acyclicity` (**error**), `helper_fan_in` (`info`, `report` per distribution) |
| **Definitions** | [`NFR-DEF-01`](NFR-DEF-01-common-definitions-EN.md) |
...
* **fan-in is not proof of belonging.** A cross-cutting capability
  ([`NFR-ORG-04`](NFR-ORG-04-crosscutting-capability-EN.md)) and a module implementing a contract
...
[`NFR-SEC-03`](NFR-SEC-03-supply-chain-locality-EN.md). Placement of cross-cutting capabilities:
[`NFR-ORG-04`](NFR-ORG-04-crosscutting-capability-EN.md). Module and class names:
[`NFR-ORG-02`](NFR-ORG-02-class-nomenclature-EN.md).
