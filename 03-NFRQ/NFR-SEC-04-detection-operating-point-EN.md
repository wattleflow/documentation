# NFR-SEC-04 — Detection operating point and psychological acceptability
...
* [`NFR-OBS-01`](NFR-OBS-01-audit-levels-EN.md) — an `ERROR` that is not a failure is a false
  alarm and spends the attention a real failure needs; same anchor (signal detection theory).
* [`NFR-SEC-06`](NFR-SEC-06-audit-confidentiality-EN.md) c.4 — redaction that disables diagnosis
