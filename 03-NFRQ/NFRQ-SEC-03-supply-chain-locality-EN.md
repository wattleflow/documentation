...
| | |
|---|---|
| **Status** | Proposal (Draft, 2026-07-09; moved from `NFRQ-ORG-06` and extended 2026-07-22) |
| **Quality (25010)** | Maintainability (modularity) · Security (integrity); NIST OSCAL for SBOM evidence |
| **Decisions** | [`DR-WFL-002`](../04-DR/DR-WFL-002-distribution-locality.md) · [`DR-WFL-003`](../04-DR/DR-WFL-003-guarded-optional-dependency.md) · [`DR-WFL-006`](../04-DR/DR-WFL-006-core-dependency-pin-and-versioning.md) · [`DR-WFL-010`](../04-DR/DR-WFL-010-packaging-allowlist-over-namespace-tree.md) |
...
> [`NFRQ-ORG-01`](NFRQ-ORG-01-helper-locality-EN.md) (dependency locality) **across the
...
6. **`[M]` Correlated breach.** `Blast` ([`NFRQ-SEC-01`](NFRQ-SEC-01-blast-radius-EN.md)) is
