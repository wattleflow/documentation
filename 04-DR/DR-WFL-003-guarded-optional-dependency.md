...
| | |
|---|---|
| **Status** | **Aktivan** (Prihvaćeno 2026-07-15) — mijenja `NFRQ-SEC-03` kriterij 1 |
| **Datum** | 2026-07-15 |
| **Verzija** | 2 (2026-07-28) — v1: 2026-07-15 |
| **Realizira** | §7 Zero-trust (packaging), uz očuvanu funkcionalnost core konfiguracije |
| **Mijenja** | `DR-WFL-002` §2.1 (Lokalnost distribucije), `NFRQ-SEC-03` kriterij 1 (tada `NFRQ-ORG-06`) |
| **Kontekst rada** | Dovršetak decouplinga `wattleflow-workflow` corea od third-partyja (2026-07-15) |
| **Sljedivost** | `PHILOSOPHY.md` (Zero-trust, Kritičko razmišljanje) · `METHODOLOGY.md` §1, §6, §8 · `POLICY.md` §7 · [`NFRQ-SEC-03`](../03-NFRQ/NFRQ-SEC-03-supply-chain-locality-EN.md) |
