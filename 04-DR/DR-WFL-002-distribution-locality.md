...
| | |
|---|---|
| **Status** | **Aktivan** (Prihvaćeno 2026-07-09, uz manje izmjene) — podložno reviziji do v1.0; predlaže **`NFRQ-SEC-03`** |
| **Datum** | 2026-07-09 |
| **Verzija** | 2 (2026-07-28) — v1: 2026-07-09 |
| **Realizira** | §7 Zero-trust (packaging), NFRQ-ORG-01 (Dependency Locality) preko granice distribucije |
| **Predlaže** | `NFRQ-SEC-03` — lokalnost distribucije i supply-chain (zapisan 2026-07-09 kao `NFRQ-ORG-06`, povučen i dekomponiran 2026-07-22) |
...
| **Sljedivost** | `PHILOSOPHY.md` (Zero-trust, Samoopisivost) · `METHODOLOGY.md` §5, §9 · `CLAUDE.md` §7, §2.6/§2.7 · `03-NFRQ/` NFRQ-ORG-01 |
...
kao **NFRQ-ORG-06 kriterij 5**. (Primjer epistemičkog rasta iz `PHILOSOPHY.md` „Doktrina".)
...
| NFRQ-ORG-01 | isti princip lokalnosti, proširen s intra-tree na inter-distribution |
...
- **NFRQ-ORG-06** (predložen ovim DR-om, **upisan u `03-NFRQ/` 2026-07-09**; kriterij 5
